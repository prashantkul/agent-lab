...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('visibility', postgresql.ENUM('draft', 'pilot_review', 'active', 'archived', name='modulevisibility', create_type=False), nullable=False, server_default='draft'),
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('reviewer', 'student', 'admin', name='userrole', create_type=False), nullable=False, server_default='reviewer'),
